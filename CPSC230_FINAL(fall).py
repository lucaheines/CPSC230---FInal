...
cap = cv2.VideoCapture(video_path)  # You can use "0" for your webcam, however I wanted to use a preset video I had on my computer, hence the variable video_path
model = YOLO("yolov8m.pt") 

# We are only interested in detecting people, so I use YOLO's preset dataset for human detection which is very simple
...
while True: # This loop is where the continuous processing of video frames happen
    ...
    # And this exits by pressing 'ESC' key
    if cv2.waitKey(1) == 27:
        break
